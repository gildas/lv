...
// KubeCtlGetApplications gets the applications for the current context
func KubeCtlGetApplications(ctx context.Context, cmd *cobra.Command, args []string, toComplete string) ([]string, error) {
	...
	log.Debugf("Getting applications for completion with args: %s", args)
	...
	return FilterValidArgs(applications, args, toComplete), nil
}
